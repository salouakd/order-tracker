import { remove, update, is } from 'ramda';
...
export { CLR_BLACK, CLR_OFFWHITE, CLR_WHITE, index as DateUtils, index$1 as Utils, constructAlphaBackdrop, constructAlphaGradient, constructHueGradient, constructLinearGradient, debounce, hexToRgb, hexaToRgb, l, parseColor, parseRgbString, partition, removeFromArray, rgbToHex, rgbToHsv, rgbaToHex, templatify, toDataUrl, toDec, toHex, uid, updateArray };
