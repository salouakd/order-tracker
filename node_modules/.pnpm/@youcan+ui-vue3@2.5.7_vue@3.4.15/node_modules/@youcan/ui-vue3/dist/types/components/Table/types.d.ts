...
declare type TableColumnSize = `${IntegerRange<0, 100>}.${IntegerRange<0, 100>}%`;
export declare type TableColumnSort = 'none' | 'asc' | 'desc';
...
export declare type TableComposableVariant = 'link' | 'thumbnail' | 'status' | 'static-status' | 'percentage' | 'button' | 'rating' | 'toggle' | 'counter' | 'icon' | 'input';
...
export declare type TableDataComposable = TableComposable<'link', TableDataLink> | TableComposable<'thumbnail', TableDataThumbnail> | TableComposable<'status', TableDataStatus> | TableComposable<'static-status', TableDataStaticStatus> | TableComposable<'percentage', TableDataPercentage> | TableComposable<'button', TableDataButton, {
    click: () => void;
}> | TableComposable<'rating', TableDataRating> | TableComposable<'toggle', TableDataToggle> | TableComposable<'counter', TableDataCounter> | TableComposable<'input', TableDataInput>;
...
export declare type TableDataInput = TableDataNumberInput | TableDataGenericInput;
