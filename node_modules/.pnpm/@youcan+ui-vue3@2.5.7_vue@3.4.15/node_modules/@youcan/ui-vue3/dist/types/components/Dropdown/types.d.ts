...
export declare type DropdownItemDefinition<T = any> = DropdownItemWithIcon<T> | DropdownItemWithImage<T>;
export declare type DropdownItemArray<T = any> = DropdownItemDefinition<T>[];
export declare type DropdownItemGroups<T = any> = Record<string, DropdownItemArray<T>>;
