import {
  defu
} from "./chunk-7FX6XHM6.js";
import {
  destr
} from "./chunk-VKP4R4A6.js";
import {
  decode,
  decodePath,
  getQuery,
...
// node_modules/.pnpm/h3@1.10.0/node_modules/h3/dist/index.mjs
...
function getRequestIP(event, opts = {}) {
  ...
  if (opts.xForwardedFor) {
    const xForwardedFor = (_b = (_a = getRequestHeader(event, "x-forwarded-for")) == null ? void 0 : _a.split(",")) == null ? void 0 : _b.pop();
    if (xForwardedFor) {
...
function getRequestWebStream(event) {
  ...
  return ((_b = (_a = event.web) == null ? void 0 : _a.request) == null ? void 0 : _b.body) || event._requestBody || new ReadableStream({
    start: (controller) => {
